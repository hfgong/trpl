...
int main(int argc, char *argv[]) 
{
	...
	vis_perf_eval(results_plan, gt, corres, "gt2rst_pl%05d.png", "rst2gt_pl%05d.png");
	...
	vis_perf_eval(results_app, gt, corres, "gt2rst_ap%05d.png", "rst2gt_ap%05d.png");
	...
	vis_perf_eval(results_alone, gt, corres, "gt2rst_al%05d.png", "rst2gt_al%05d.png");
		   ...
		   std::string const& fmt2)
{
    ...
    matrix<CImg<unsigned char> > patches_gt(Ncam, gt.size1());
    matrix<CImg<unsigned char> > patches_rst(Ncam, results.size1());
