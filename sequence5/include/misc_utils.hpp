...
rectint(V const& r1, V const& r2)
{
    typedef typename V::value_type Float;
    Float dy = (std::min(r1(2), r2(2))-std::max(r1(0), r2(0)));
    Float dx = (std::min(r1(3), r2(3))-std::max(r1(1), r2(1)));
